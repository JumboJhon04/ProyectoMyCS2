...
import './Profile.css';
import { FaUser, FaEnvelope, FaIdCard, FaCamera, FaEdit, FaSave, FaTimes, FaFileUpload, FaTrash, FaPen } from 'react-icons/fa';
...
const ResponsableProfile = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setUser(prev => ({
        ...
        fotoPerfil: result.data.FOTO_PERFIL
      }));
  ...
  if (isEditing) {
      ...
      if (user.fotoPerfil || user.FOTO_PERFIL) avatarSrc = user.fotoPerfil || user.FOTO_PERFIL;
  }
    ...
    <div className="profile-wrapper">
      <div className="profile-card-split">
        ...
        <div className="profile-left-panel">
            ...
            <span className="profile-role-badge">Responsable</span>
                ...
                {!isEditing ? (
                    <div className="info-grid">
                         ...
                         <div className="info-item full">
                            ...
                            <span className="info-value">{user.correo || user.CORREO}</span>
                         </div>
                    </div>
                ) : (
...
export default ResponsableProfile;
