...
import { FaHome, FaCalendarAlt, FaSearch, FaUsers, FaLifeRing, FaClipboardList, FaChartBar } from "react-icons/fa";
import "./Sidebar.css";
...
const AdminSidebar = ({ isOpen, onClose }) => {
  ...
  const menuItems = [
    ...
    { id: "reportes", label: "Reportes", icon: FaChartBar, to: "/admin/reportes" },
